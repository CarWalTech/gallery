...
final class Schema25 extends i0.VersionedSchema {
  ...
  late final Shape47 localAlbumAssetEntity = Shape47(
    source: i0.VersionedTable(
      ...
      isStrict: true,
      tableConstraints: ['PRIMARY KEY(asset_id, album_id)'],
      columns: [_column_176, _column_177, _column_175],
      attachedDatabase: database,
    ),
    alias: null,
  );
  ...
  late final Shape4 userMetadataEntity = Shape4(
    source: i0.VersionedTable(
      ...
      isStrict: true,
      tableConstraints: ['PRIMARY KEY(user_id, "key")'],
      columns: [_column_161, _column_183, _column_184],
      attachedDatabase: database,
    ),
    alias: null,
  );
  late final Shape49 partnerEntity = Shape49(
    source: i0.VersionedTable(
      ...
      isStrict: true,
      tableConstraints: ['PRIMARY KEY(shared_by_id, shared_with_id)'],
      columns: [_column_185, _column_186, _column_187],
      attachedDatabase: database,
    ),
    alias: null,
  );
  ...
  late final Shape7 remoteAlbumAssetEntity = Shape7(
    source: i0.VersionedTable(
      ...
      isStrict: true,
      tableConstraints: ['PRIMARY KEY(asset_id, album_id)'],
      columns: [_column_188, _column_205],
      attachedDatabase: database,
    ),
    alias: null,
  );
  late final Shape10 remoteAlbumUserEntity = Shape10(
    source: i0.VersionedTable(
      ...
      isStrict: true,
      tableConstraints: ['PRIMARY KEY(album_id, user_id)'],
      columns: [_column_205, _column_161, _column_206],
      attachedDatabase: database,
    ),
    alias: null,
  );
  ...
  late final Shape12 memoryAssetEntity = Shape12(
    source: i0.VersionedTable(
      ...
      isStrict: true,
      tableConstraints: ['PRIMARY KEY(asset_id, memory_id)'],
      columns: [_column_188, _column_215],
      attachedDatabase: database,
    ),
    alias: null,
  );
  ...
  late final Shape18 storeEntity = Shape18(
    source: i0.VersionedTable(
      ...
      isStrict: true,
      tableConstraints: ['PRIMARY KEY(id)'],
      columns: [_column_229, _column_230, _column_231],
      attachedDatabase: database,
    ),
    alias: null,
  );
...
i1.GeneratedColumn<i2.Uint8List> _column_184(String aliasedName) =>
    i1.GeneratedColumn<i2.Uint8List>(
      'value',
      aliasedName,
      false,
...
i1.GeneratedColumn<double> _column_196(String aliasedName) =>
    i1.GeneratedColumn<double>(
      'focal_length',
      aliasedName,
      true,
